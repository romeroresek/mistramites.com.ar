...
import { ArrowLeft, Home, FileText, LayoutDashboard, LogOut, LogIn, UserPlus, Menu, X, MessageCircle } from "lucide-react"

interface PageNavbarProps {
  backHref?: string
}

export function PageNavbar({ backHref = "/" }: PageNavbarProps) {
      ...
      >
        ...
        <div className="p-2 flex flex-col gap-1">
          ...
          <a
            ...
            onClick={() => setMenuOpen(false)}
            className="px-3 py-2.5 text-sm text-green-600 hover:bg-green-50 rounded-lg min-h-[44px] flex items-center gap-2"
          >
