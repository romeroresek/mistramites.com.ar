      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <Link href="/" className="inline-flex items-center gap-2">
            <Image src="/icon.png" alt="MisTrámites" width={40} height={40} className="w-8 h-8 sm:w-10 sm:h-10" />
            <span className="text-xl sm:text-2xl font-semibold text-gray-800">MisTrámites</span>
          </Link>
        </div>
        ...
        <div className="bg-white rounded border border-gray-200">
          <div className="p-4 sm:p-6 border-b border-gray-200">
            <h1 className="text-lg sm:text-xl font-semibold text-gray-900 text-center">Iniciar sesión</h1>
          </div>
          ...
          <div className="p-4 sm:p-6">
            ...
            <p className="text-gray-600 text-xs sm:text-sm text-center mb-6">
              Accedé a tu cuenta para gestionar tus trámites
            </p>
