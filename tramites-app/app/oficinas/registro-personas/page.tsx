...
const TRAMITES = [
  ...
  { id: "actualizacion-datos", nombre: "Actualización de Datos Personales", monto: 400 },
  { id: "certificado", nombre: "Certificado de Existencia", monto: 300 },
  { id: "rectificacion", nombre: "Rectificación de Errores", monto: 700 },
]
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Registro de las Personas</h1>
        </div>
      </header>
